entry {
    path: "data/title/slpl02a.png",
    path_2: "data/title/slpl02a_a.png",
    has_data: false,
    rt_width: 256,
    rt_height: 256,
...
interrupt[10]:
    ins_2(0.0, 1.0);
    ins_17(576.0, 128.0, 0.0);
    ins_30(1.0, 1.0, 10);
    ins_18(448.0, 128.0, 0.0, 10);
+10: // 40
    ins_21();
...
interrupt[12]:
    ins_17(448.0, 128.0, 0.0);
    ins_2(1.0, 1.0);
    ins_30(0.0, 1.0, 10);
    ins_18(576.0, 128.0, 0.0, 10);
+10: // 60
    ins_24();
